...
result_word, similar_word, similarity, similar_word, labels, label_dict, color_map = gen_similarity(key_word, 20)
result_word_2, similar_word_2, similarity_2, similar_word_2, labels_2, label_dict_2, color_map_2 = gen_similarity(similar_word, 10)
elist = []
